...
def main():
    ...
    print('UICM:%.4f' % (uicm / len(os.listdir(SAMPLE_DIR))), 'UISM:%.4f' % (uism / len(os.listdir(SAMPLE_DIR))),'UICONM:%.4f' % (uiconm / len(os.listdir(SAMPLE_DIR))), 'UIQM:%.4f' % (uiqm / len(os.listdir(SAMPLE_DIR))))
