...
def main():
    ...
    with torch.no_grad():
        ...
        #images['lv1'] = images['lv1'][:, 0:1280, 0:720]
        ...
        #uiqm += uiqm_
        iteration += 1
    #print('UICM:%.3f' % (uicm / len(os.listdir(SAMPLE_DIR))), 'UISM:%.3f' % (uism / len(os.listdir(SAMPLE_DIR))),
    #          'UICONM:%.3f' % (uiconm / len(os.listdir(SAMPLE_DIR))),
    #          'UIQM:%.3f' % (uiqm / len(os.listdir(SAMPLE_DIR))))
