...
parser.add_argument("-e","--epochs",type = int, default = 4001)
...
def main():
    ...
    for epoch in range(args.start_epoch, EPOCHS):
        ...
        for iteration, inputs in enumerate(train_dataloader):            
            ...
            loss = mse(255*residual['s4']['lv1'], 255*images['gt']) + mse(255*residual['s3']['lv1'], 255*images['gt']) +  mse(255*residual['s2']['lv1'], 255*images['gt']) + mse(255*residual['s1']['lv1'], 255*images['gt'])
            ...
            if (iteration+1)%100 == 0:
                print(METHOD + "epoch:", epoch, "iteration:", iteration+1, "loss:",loss.item())
